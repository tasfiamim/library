...
<div class="container">
	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <?php } ?>
		  	<div class="row">
		  	  <a><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button"  style="background-color: #5D5D5D"> Fines</button></a>
		  ...
		  <table class="table table-bordered">
		          ...
		          <tbody> 
		            <tr> 
		             ...
		             <button name="check" type="submit" class="btn btn-warning" style="background-color: #282828">CHECK</button>
		             </form>
		             </td>
		            </tr> 
		            <?php } ?> 
