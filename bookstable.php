...
<div class="container">
	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <?php } ?>
		  	<div class="row">
		  	  <a href="addbook.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button"  style="background-color: #5D5D5D"><span class="glyphicon glyphicon-plus-sign"></span> Add Book</button></a>
