	...
	<div class="container col-lg-11 ">
		<div class="panel panel-default">
		  ...
		  <div class="panel-heading">
		  	<div class="row">
		  	  <a href="addstudent.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="background-color: #5D5D5D"><span class="glyphicon glyphicon-plus-sign"></span> Add Student</button></a>
		  ...
		  <table class="table table-bordered">
		          ...
		          <tbody> 
		            <tr> 
		             ...
		             <button name="submit" class="btn btn-warning" style="background-color: #282828">DELETE</button>
		             </form> 
		         </td>
		            </tr> 
