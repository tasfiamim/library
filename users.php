...
<div class="container">
    ...
    <!-- navbar ends -->
    <!-- info alert -->
    <div class="alert alert-warning col-lg-7 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="background-color: #E5E5E5">

        <span class="glyphicon glyphicon-book"></span>
        <strong>Admin</strong> List
    </div>
	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <?php } ?>
		  	<div class="row">
          <a href="adduser.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="background-color: #5D5D5D"><span class="glyphicon glyphicon-plus-sign"></span> Add Admin</button></a>
	...
	while($row=mysqli_fetch_array($query)){ ?>
	   ...
	   <td><button name='del' type='submit' value='Delete' class='btn btn-warning' style="background-color: #282828"onclick='return Delete()'>DELETE</button></td>
	   </form>
	   </tbody>
